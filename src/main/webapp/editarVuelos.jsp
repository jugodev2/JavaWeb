<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ page import="java.util.List" %>
    ...
    <%
      ...
      Aeropuerto origen = (Aeropuerto) request.getAttribute("origen");
      Aeropuerto destino = (Aeropuerto) request.getAttribute("destino");
                  ...
                  <div class="collapse navbar-collapse" id="navbarText">
                      <ul class="navbar-nav mr-auto">
                          ...
                          <li class="nav-item dropdown">
                              <a class="nav-link dropdown-toggle" href="" id="aerolineas" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                  Aerolineas
                              </a>
          ...
          <% List<String> errores = (List<String>) request.getAttribute("errores");
              ...
              <% } %>
                <form action="<%=request.getContextPath()%>/vuelos/actualizar" method="post">
                  <div class="mb-3">
                    <input type="hidden" class="form-control" id="id" name="id" value="<%=vuelo.getId()%>">
                  </div>
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="salida" name="salida"
                      value="<%=vuelo.getFechaSalida()%>" pattern=".*\S.*" required>
                  </div>
